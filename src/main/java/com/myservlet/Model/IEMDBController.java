...
public class IEMDBController {
    ...
    public static IEMDBController getInstance(){
    ...
    public static Document rateMovie(String user_id, String movie_id, String rate) throws IOException {
        try{
            userHandler.findUser(user_id);
            Movie movie = movieHandler.findMovie(valueOf(movie_id));
    ...
    public static Document addToWatchList(String user_id, String movie_id) throws IOException {
        try {
            User user = userHandler.findUser(user_id);
            movieHandler.findMovie(valueOf(movie_id));
    ...
    public static Document getWatchList(String user_id) throws IOException {
        try {
