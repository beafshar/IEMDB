...
//
//    @Test
//    public void userRatesAMovieTwice() throws JSONException {
//        int score = 4;
//        Movie movie =  MV.returnMovieObjectGivenId(3);
//        double rate  = movie.getRating();
//        double ratingCount = movie.getRatingCount();
...
//        JSONObject response = MV.rateMovie("{\"userEmail\": \"beafshar@gmail.com\", \"movieId\": 3, \"score\": 100}");
...
//
//    @Test
//    public void getMoviesByGenresSuccessfully() throws JSONException {
//        JSONObject response = MV.getMovieByGenre("{\"genre\": \"Drama\"}");
...
//
//    @Test
//    public void noMovieFoundForGivenGenre() throws JSONException {
//        JSONObject response =  MV.getMovieByGenre("{\"genre\": \"Mystery\"}");
//        System.out.println(response);
